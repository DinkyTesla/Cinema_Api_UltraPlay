...
namespace CinemAPI.Domain.Constants
{
    ...
    {
        public const string ProjectionAlreadyStarted = "It is too late for tickets for this projection!";
        ...
        public const string ReservationExpired = "Reservation already expired!";
        public const string ReservationDoesNotExist = "There is no registration with such number!";
        ...
        public const string TicketCreated = "You have just bought a ticket!";
